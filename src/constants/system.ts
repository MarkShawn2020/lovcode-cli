...
const DEFAULT_PREFIX = `You are Lovstudio Code, an AI coding assistant in the terminal, powered by Claude.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Lovstudio Code, an AI coding assistant powered by Claude, running within the Claude Agent SDK.`
